...
function initNavigation() {
    ...
    // const html = document.documentElement; // Best for locking scroll on root
    ...
    if (mobileToggle && navLinks) {
        mobileToggle.addEventListener('click', () => {
            ...
            // FIX: Prevent background scrolling using class on HTML/Body
            if (isActive) {
    ...
    links.forEach(link => {
        link.addEventListener('click', () => {
            ...
            if (navLinks) {
                ...
                document.documentElement.classList.remove('no-scroll'); // Release scroll lock
            }
        });
    });
